...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/lehuynh)](https://CRAN.R-project.org/package=lehuynh)
...
This package is also accessible for download via Zenodo with the DOI [10.5281/zenodo.11522849](https://doi.org/10.5281/zenodo.11522849).


### Functions
- `cal_tn()`: Calculate Total Nitrogen (TN) concentration for samples using spectrophotometric data
